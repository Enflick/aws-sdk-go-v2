module github.com/Enflick/aws-sdk-go-v2/feature/dynamodb/attributevalue
...
require (
	...
	github.com/Enflick/aws-sdk-go-v2/service/dynamodbstreams v0.0.0-20250325155711-0a4bf6fdbeb3
)
