module github.com/Enflick/aws-sdk-go-v2/service/timestreamwrite
...
require (
	...
	github.com/Enflick/aws-sdk-go-v2/service/internal/endpoint-discovery v0.0.0-20250325155711-0a4bf6fdbeb3
